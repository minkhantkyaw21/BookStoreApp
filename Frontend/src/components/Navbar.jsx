...
import Logout from "../courses/Logout";
      ...
      >
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className="text-xl font-bold cursor-pointer">Book-Store</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            {authUser ? (
              ...
              <div className="">
                <a
                  className="btn bg-black text-white p-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
                  onClick={() =>
